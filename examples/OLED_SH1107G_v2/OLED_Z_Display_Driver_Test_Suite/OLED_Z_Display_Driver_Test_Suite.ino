...
void loop()
{
  ...
  SeeedGrayOled.clearDisplay();                  //  clear the screen and set start position to top left corner
  //Draw binary Bitmap
  SeeedGrayOled.drawBitmap(SeeedLogo128x128,sizeof SeeedLogo128x128);   //  Draw binary Bitmap (96 pixels *96 pixels  / 8) bytes
  delay(10000);  
  
  setDisplayToOriginalState();  
  SeeedGrayOled.setInverseDisplay();             // Set Display to inverse mode  
  SeeedGrayOled.clearDisplay();                  //  clear the screen and set start position to top left corner
  SeeedGrayOled.drawBitmap(SeeedLogo128x128,sizeof SeeedLogo128x128);   // (96 pixels *96 pixels  / 8) bytes
  delay(10000);        
}
